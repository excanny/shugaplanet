					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card card-box">
								<div class="card-head">
									<header><meta http-equiv="Content-Type" content="text/html; charset=utf-8">Recent Requests</header>
								</div>
										...
										<div class="col-sm-4" style="margin:0px; padding:2px;">
										   <div class="card">
												...
												<div class="card-body no-padding height-9">
													...
													<p class="example"><i class="fa fa-commenting-o fa-lg" style="color:#F39C12;"></i> <?php echo $request->content; ?></p>
												</div>
										...
										<div class="">
											...
											<div class="form-group">
												...
												<div class="row">
												  <div class="col-lg-5">
													<div class="form-group">
														<select id="request_type" name="request_type" class="form-control" required data-toggle="tooltip" title="Select Request Type">
													...
													<div class="col-lg-3">
													  <div class="form-group">
														<input type="number" name="age" id="age" class="form-control" min="18" placeholder="Your Age" data-toggle="tooltip" title="Your Age">
													   </div>
													</div>
													<div class="col-lg-4">
														<div class="form-group">
