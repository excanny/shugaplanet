                ...
                <div class="row">
                  ...
                  <form action="<?php echo site_url();?>user/RegisterAction" method="post">
                    ...
                    <label for="">Last Name:</label>
                      <input type="text" name="last_name" class="inputbox" required>
                    </div>
                    <div class="six columns">
                    ...
                    <div class="four columns">
                      <select id="dobday" name="dobday" style="padding: 6px; display: block;  margin: 0 0 12px 0; border: 1px solid #ccc;" required></select>
                    </div>
                    <div class="four columns">
                    <select id="dobmonth" name="dobmonth" style="padding: 6px; display: block;  margin: 0 0 12px 0; border: 1px solid #ccc;" required></select>
                    </div>
                    <div class="four columns">
                     <select id="dobyear" name="dobyear" style="padding: 6px; display: block;  margin: 0 0 12px 0; border: 1px solid #ccc;" required></select>
                    </div>
