...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<!-- favicon -->
	<link rel="shortcut icon" href="https://radixtouch.in/templates/admin/smart/source/assets/img/favicon.ico" />
...
<body
			...
			<div class="page-header-inner ">
				...
				<div class="top-menu">
					...
					<?php if($this->session->userdata('is_admin') == 1){ ?>
						<li><a href="<?php echo site_url();?>admin"><u>Go to Admin Dashboard </u> </a></li>
					<?php } ?>	
					...
					<div id="remove-scroll" class="left-sidemenu">
						<ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
							...
							<li class="sidebar-user-panel">
								...
								<p class="text-center">Balance:  <?php echo '₦' . ' ' . $user->sub;?></p>
							</li>
    ...
    <script src="<?php echo base_url();?>assets2/js/jquery.expandable.js"></script>
