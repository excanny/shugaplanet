			...
			<div class="page-header-inner ">
				...
				<div class="top-menu">
					<ul class="nav navbar-nav pull-right">
						<li><a href="<?php echo site_url();?>user/dashboard"><u>Go to User Dashboard </u> </a></li>
				...
				<div class="sidemenu-container navbar-collapse collapse fixed-menu">
					<div id="remove-scroll" class="left-sidemenu">
						<ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
							...
							<li class="nav-item">
							   <a class="nav-link"> <i class="material-icons"style="font-size:22px;">face</i>
									<span class="title">Manage Users</span> <span class="arrow"></span>
								</a>
								<ul class="">
									<li class="nav-item">
										<a href="<?php echo site_url();?>admin/users" class="nav-link"> <span class="title">All Users</span> 
										</a>
									</li>
									<li class="nav-item">
										<a href="<?php echo site_url();?>admin/vips" class="nav-link"> <span class="title">All VIPs</span> 
										</a>
									</li>
								</ul>
							</li>
